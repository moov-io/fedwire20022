...
func (v AccountTypeFRS1) Validate() error {
	if err := fedwire.ValidateEnumeration(string(v), "S"); err != nil {
		return err
	}
	return nil
}
...
func (v BalanceReportFRS1) Validate() error {
	if err := fedwire.ValidateEnumeration(string(v), "PRDC", "OPEN", "ABMS"); err != nil {
		return err
	}
	return nil
}
...
func (v BalanceTypeFRS1) Validate() error {
	if err := fedwire.ValidateEnumeration(string(v), "ABAL", "AVLD", "DLOD", "OBFL", "OBNL", "OBPL"); err != nil {
		return err
	}
	return nil
}
...
func (v TransactionsSummaryTypeFRS1) Validate() error {
	if err := fedwire.ValidateEnumeration(string(v), "FDWS", "NSSE", "AVOT", "UVOT", "FDWF", "FDAP", "FDNF"); err != nil {
		return err
	}
	return nil
}
