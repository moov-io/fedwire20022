...
// Validations for urn:iso:std:iso:20022:tech:xsd:pain.013.001.04
...
func (v CreditTransferTransaction21) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CreditTransferTransaction21"
...
func (v CreditorPaymentActivationRequestV04) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CreditorPaymentActivationRequestV04"
...
func (v PaymentInstruction17) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentInstruction17"
	if v.PmtInfId != nil {
