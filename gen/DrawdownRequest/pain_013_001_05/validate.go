...
// Validations for urn:iso:std:iso:20022:tech:xsd:pain.013.001.05
...
func (v CreditorPaymentActivationRequestV05) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CreditorPaymentActivationRequestV05"
...
func (v PaymentInstruction19) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentInstruction19"
	if v.PmtInfId != nil {
