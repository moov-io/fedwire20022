...
// Validations for urn:iso:std:iso:20022:tech:xsd:pain.013.001.08
...
func (v CreditTransferTransaction42) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CreditTransferTransaction42"
...
func (v CreditorPaymentActivationRequestV08) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CreditorPaymentActivationRequestV08"
...
func (v PaymentInstruction35) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentInstruction35"
	if v.PmtInfId != nil {
