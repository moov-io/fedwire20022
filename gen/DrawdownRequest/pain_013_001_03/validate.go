...
// Validations for urn:iso:std:iso:20022:tech:xsd:pain.013.001.03
...
func (v CreditTransferTransaction10) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CreditTransferTransaction10"
...
func (v CreditorPaymentActivationRequestV03) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CreditorPaymentActivationRequestV03"
...
func (v PaymentInstruction11) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentInstruction11"
	if v.PmtInfId != nil {
