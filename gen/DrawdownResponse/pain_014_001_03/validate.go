...
// Validations for urn:iso:std:iso:20022:tech:xsd:pain.014.001.03
...
func (v CreditorPaymentActivationRequestStatusReportV03) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CreditorPaymentActivationRequestStatusReportV03"
...
func (v OriginalPaymentInstruction9) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalPaymentInstruction9"
...
func (v OriginalTransactionReference19) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalTransactionReference19"
	if v.Amt != nil {
		fedwire.AddError(&errs, baseName+".Amt", v.Amt.Validate())
	}
...
func (v PaymentTransaction49) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction49"
	if v.StsId != nil {
