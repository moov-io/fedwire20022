...
// Validations for urn:iso:std:iso:20022:tech:xsd:pain.014.001.05
...
func (v CreditorPaymentActivationRequestStatusReportV05) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CreditorPaymentActivationRequestStatusReportV05"
...
func (v OriginalPaymentInstruction19) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalPaymentInstruction19"
...
func (v OriginalTransactionReference23) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalTransactionReference23"
	if v.Amt != nil {
		fedwire.AddError(&errs, baseName+".Amt", v.Amt.Validate())
	}
...
func (v PaymentTransaction69) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction69"
	if v.StsId != nil {
