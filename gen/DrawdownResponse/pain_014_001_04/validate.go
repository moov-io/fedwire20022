...
// Validations for urn:iso:std:iso:20022:tech:xsd:pain.014.001.04
...
func (v CreditorPaymentActivationRequestStatusReportV04) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CreditorPaymentActivationRequestStatusReportV04"
...
func (v OriginalPaymentInstruction14) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalPaymentInstruction14"
...
func (v OriginalTransactionReference21) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalTransactionReference21"
	if v.Amt != nil {
		fedwire.AddError(&errs, baseName+".Amt", v.Amt.Validate())
	}
...
func (v PaymentTransaction59) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction59"
	if v.StsId != nil {
