...
// Validations for urn:iso:std:iso:20022:tech:xsd:pain.014.001.08
...
func (v CreditorPaymentActivationRequestStatusReportV08) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CreditorPaymentActivationRequestStatusReportV08"
...
func (v OriginalPaymentInstruction39) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalPaymentInstruction39"
...
func (v OriginalTransactionReference33) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalTransactionReference33"
	if v.Amt != nil {
		fedwire.AddError(&errs, baseName+".Amt", v.Amt.Validate())
	}
...
func (v PaymentTransaction128) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction128"
	if v.StsId != nil {
