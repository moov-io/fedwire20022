...
// Validations for urn:iso:std:iso:20022:tech:xsd:pain.014.001.06
...
func (v CreditorPaymentActivationRequestStatusReportV06) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CreditorPaymentActivationRequestStatusReportV06"
...
func (v OriginalGroupInformation28) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalGroupInformation28"
...
func (v OriginalPaymentInstruction24) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalPaymentInstruction24"
...
func (v OriginalTransactionReference26) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalTransactionReference26"
	if v.Amt != nil {
		fedwire.AddError(&errs, baseName+".Amt", v.Amt.Validate())
	}
...
func (v PaymentTransaction83) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction83"
	if v.StsId != nil {
