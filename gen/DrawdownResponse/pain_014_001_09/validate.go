...
// Validations for urn:iso:std:iso:20022:tech:xsd:pain.014.001.09
...
func (v CreditorPaymentActivationRequestStatusReportV09) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CreditorPaymentActivationRequestStatusReportV09"
...
func (v OriginalPaymentInstruction42) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalPaymentInstruction42"
...
func (v OriginalTransactionReference37) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalTransactionReference37"
	if v.Amt != nil {
		fedwire.AddError(&errs, baseName+".Amt", v.Amt.Validate())
	}
...
func (v PaymentTransaction136) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction136"
	if v.StsId != nil {
