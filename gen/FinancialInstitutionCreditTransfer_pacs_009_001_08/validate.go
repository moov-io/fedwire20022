...
func (v Document) Validate() error {
	...
	baseName := "Document"
	fedwire.AddError(&errs, baseName+".FICdtTrf", v.FICdtTrf.Validate())
	if errs.Empty() {
		return nil
	}
	return errs
...
func (v CreditTransferTransaction371) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CreditTransferTransaction371"
	if v.UltmtDbtr != nil {
...
func (v InstructionForCreditorAgent2) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "InstructionForCreditorAgent2"
	if v.Cd != nil {
		fedwire.AddError(&errs, baseName+".Cd", v.Cd.Validate())
	}
	if v.InstrInf != nil {
...
func (v InstructionForNextAgent11) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "InstructionForNextAgent11"
	fedwire.AddError(&errs, baseName+".InstrInf", v.InstrInf.Validate())
	if errs.Empty() {
		return nil
	}
...
func (v Instruction5Code) Validate() error {
	if err := fedwire.ValidateEnumeration(string(v), "PHOB", "TELB"); err != nil {
		return err
	}
	return nil
}
...
func (v LocalInstrumentFedwireFunds1) Validate() error {
	if err := fedwire.ValidateEnumeration(string(v), "BTRC", "BTRS", "COVC", "COVS", "BTRD"); err != nil {
		return err
	}
	return nil
}
