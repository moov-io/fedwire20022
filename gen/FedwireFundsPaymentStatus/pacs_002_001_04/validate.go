...
// Validations for urn:iso:std:iso:20022:tech:xsd:pacs.002.001.04
...
func (v FIToFIPaymentStatusReportV04) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "FIToFIPaymentStatusReportV04"
...
func (v PaymentTransaction33) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction33"
	if v.StsId != nil {
