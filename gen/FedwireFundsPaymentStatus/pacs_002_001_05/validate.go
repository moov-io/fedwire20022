...
// Validations for urn:iso:std:iso:20022:tech:xsd:pacs.002.001.05
...
func (v FIToFIPaymentStatusReportV05) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "FIToFIPaymentStatusReportV05"
...
func (v PaymentTransaction43) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction43"
	if v.StsId != nil {
