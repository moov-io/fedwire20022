...
// Validations for urn:iso:std:iso:20022:tech:xsd:pacs.002.001.06
...
func (v FIToFIPaymentStatusReportV06) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "FIToFIPaymentStatusReportV06"
...
func (v PaymentTransaction52) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction52"
	if v.StsId != nil {
