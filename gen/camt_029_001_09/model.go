...
type Case5 struct {
	...
	ReopCaseIndctn *YesNoIndicator `xml:"ReopCaseIndctn,omitempty"`
}
...
type ClaimNonReceipt2 struct {
	DtPrcd      fedwire.ISODate                               `xml:"DtPrcd"`
	OrgnlNxtAgt *BranchAndFinancialInstitutionIdentification6 `xml:"OrgnlNxtAgt,omitempty"`
}
...
type ClaimNonReceiptRejectReason1Choice struct {
	Cd    *ExternalClaimNonReceiptRejection1Code `xml:"Cd,omitempty"`
	Prtry *Max35Text                             `xml:"Prtry,omitempty"`
}
...
type CorrectiveInterbankTransaction2 struct {
	...
	IntrBkSttlmDt  fedwire.ISODate                   `xml:"IntrBkSttlmDt"`
}
...
type InvestigationStatus5Choice struct {
	Conf           *ExternalInvestigationExecutionConfirmation1Code `xml:"Conf,omitempty"`
	RjctdMod       []ModificationStatusReason1Choice                `xml:"RjctdMod"`
	DplctOf        *Case5                                           `xml:"DplctOf,omitempty"`
	AssgnmtCxlConf *YesNoIndicator                                  `xml:"AssgnmtCxlConf,omitempty"`
}
...
type OriginalGroupHeader14 struct {
	OrgnlGrpCxlId    *Max35Text                        `xml:"OrgnlGrpCxlId,omitempty"`
	RslvdCase        *Case5                            `xml:"RslvdCase,omitempty"`
	...
	GrpCxlSts        *GroupCancellationStatus1Code     `xml:"GrpCxlSts,omitempty"`
...
type OriginalPaymentInstruction30 struct {
	OrgnlPmtInfCxlId *Max35Text                         `xml:"OrgnlPmtInfCxlId,omitempty"`
	RslvdCase        *Case5                             `xml:"RslvdCase,omitempty"`
	OrgnlPmtInfId    Max35Text                          `xml:"OrgnlPmtInfId"`
	OrgnlGrpInf      *OriginalGroupInformation29        `xml:"OrgnlGrpInf,omitempty"`
	OrgnlNbOfTxs     *Max15NumericText                  `xml:"OrgnlNbOfTxs,omitempty"`
	OrgnlCtrlSum     *DecimalNumber                     `xml:"OrgnlCtrlSum,omitempty"`
	PmtInfCxlSts     *GroupCancellationStatus1Code      `xml:"PmtInfCxlSts,omitempty"`
	CxlStsRsnInf     []*CancellationStatusReason4       `xml:"CxlStsRsnInf,omitempty"`
...
type PaymentTransaction102 struct {
	CxlStsId            *Max35Text                         `xml:"CxlStsId,omitempty"`
	RslvdCase           *Case5                             `xml:"RslvdCase,omitempty"`
	OrgnlGrpInf         *OriginalGroupInformation29        `xml:"OrgnlGrpInf,omitempty"`
	...
	TxCxlSts            *CancellationIndividualStatus1Code `xml:"TxCxlSts,omitempty"`
	CxlStsRsnInf        []*CancellationStatusReason4       `xml:"CxlStsRsnInf,omitempty"`
	...
	Assgnr              *Party40Choice                     `xml:"Assgnr,omitempty"`
	Assgne              *Party40Choice                     `xml:"Assgne,omitempty"`
...
type PaymentTransaction103 struct {
	...
	OrgnlReqdExctnDt  *DateAndDateTime2Choice            `xml:"OrgnlReqdExctnDt,omitempty"`
	OrgnlReqdColltnDt *fedwire.ISODate                   `xml:"OrgnlReqdColltnDt,omitempty"`
	OrgnlTxRef        *OriginalTransactionReference28    `xml:"OrgnlTxRef,omitempty"`
}

type PaymentTransaction107 struct {
	ModStsId            *Max35Text                         `xml:"ModStsId,omitempty"`
	RslvdCase           *Case5                             `xml:"RslvdCase,omitempty"`
...
type StatementResolutionEntry4 struct {
	...
	CrrctdAmt   *ActiveOrHistoricCurrencyAndAmount `xml:"CrrctdAmt,omitempty"`
