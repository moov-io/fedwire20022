...
func (v ControlData1) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "ControlData1"
...
func (v FIToFIPaymentCancellationRequestV08) Validate() error {
	...
	if v.CtrlData != nil {
		fedwire.AddError(&errs, baseName+".CtrlData", v.CtrlData.Validate())
	}
	for indx := range v.Undrlyg {
		fedwire.AddError(&errs, baseName+".Undrlyg", v.Undrlyg[indx].Validate())
	}
...
func (v OriginalGroupHeader15) Validate() error {
	...
	if v.GrpCxlId != nil {
		fedwire.AddError(&errs, baseName+".GrpCxlId", v.GrpCxlId.Validate())
	}
	if v.Case != nil {
		fedwire.AddError(&errs, baseName+".Case", v.Case.Validate())
	}
	...
	if v.GrpCxl != nil {
		fedwire.AddError(&errs, baseName+".GrpCxl", v.GrpCxl.Validate())
	}
	if v.CxlRsnInf != nil {
		for indx := range v.CxlRsnInf {
			fedwire.AddError(&errs, baseName+".CxlRsnInf", v.CxlRsnInf[indx].Validate())
		}
	}
	if errs.Empty() {
		return nil
...
func (v PaymentTransaction106) Validate() error {
	...
	if v.CxlId != nil {
		fedwire.AddError(&errs, baseName+".CxlId", v.CxlId.Validate())
	}
	if v.Case != nil {
		fedwire.AddError(&errs, baseName+".Case", v.Case.Validate())
	}
...
func (v UnderlyingTransaction23) Validate() error {
	...
	if v.OrgnlGrpInfAndCxl != nil {
		fedwire.AddError(&errs, baseName+".OrgnlGrpInfAndCxl", v.OrgnlGrpInfAndCxl.Validate())
	}
	if v.TxInf != nil {
...
func (v GroupCancellationIndicator) Validate() error {
	return nil
}
