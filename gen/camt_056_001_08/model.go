...
type OriginalGroupHeader15 struct {
	GrpCxlId     *Max35Text                    `xml:"GrpCxlId,omitempty"`
	Case         *Case5                        `xml:"Case,omitempty"`
	...
	CtrlSum      *DecimalNumber                `xml:"CtrlSum,omitempty"`
	GrpCxl       *GroupCancellationIndicator   `xml:"GrpCxl,omitempty"`
...
type PaymentTransaction106 struct {
	CxlId               *Max35Text                                    `xml:"CxlId,omitempty"`
	Case                *Case5                                        `xml:"Case,omitempty"`
	...
	Assgnr              *BranchAndFinancialInstitutionIdentification6 `xml:"Assgnr,omitempty"`
	Assgne              *BranchAndFinancialInstitutionIdentification6 `xml:"Assgne,omitempty"`
	CxlRsnInf           []*PaymentCancellationReason5                 `xml:"CxlRsnInf,omitempty"`
...
type UnderlyingTransaction23 struct {
	...
	TxInf             []*PaymentTransaction106 `xml:"TxInf,omitempty"`
}
