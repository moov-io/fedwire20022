...
// Validations for urn:iso:std:iso:20022:tech:xsd:pacs.028.001.01
...
func (v FIToFIPaymentStatusRequestV01) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "FIToFIPaymentStatusRequestV01"
...
func (v PaymentTransaction73) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction73"
	if v.StsReqId != nil {
