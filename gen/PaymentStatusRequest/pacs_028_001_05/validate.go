...
// Validations for urn:iso:std:iso:20022:tech:xsd:pacs.028.001.05
...
func (v FIToFIPaymentStatusRequestV05) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "FIToFIPaymentStatusRequestV05"
...
func (v PaymentTransaction131) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction131"
	if v.StsReqId != nil {
