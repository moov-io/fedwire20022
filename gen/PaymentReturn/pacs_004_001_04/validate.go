...
// Validations for urn:iso:std:iso:20022:tech:xsd:pacs.004.001.04
...
func (v PaymentReturnV04) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentReturnV04"
...
func (v PaymentTransaction44) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction44"
	if v.RtrId != nil {
