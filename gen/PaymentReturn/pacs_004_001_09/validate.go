...
// Validations for urn:iso:std:iso:20022:tech:xsd:pacs.004.001.09
...
func (v PaymentReturnV09) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentReturnV09"
...
func (v PaymentTransaction112) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction112"
	if v.RtrId != nil {
...
func (v TransactionParties7) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "TransactionParties7"
	if v.UltmtDbtr != nil {
		fedwire.AddError(&errs, baseName+".UltmtDbtr", v.UltmtDbtr.Validate())
	}
	fedwire.AddError(&errs, baseName+".Dbtr", v.Dbtr.Validate())
