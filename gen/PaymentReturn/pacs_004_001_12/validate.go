...
// Validations for urn:iso:std:iso:20022:tech:xsd:pacs.004.001.12
...
func (v CreditTransferTransaction52) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CreditTransferTransaction52"
	if v.UltmtDbtr != nil {
...
func (v GroupHeader99) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "GroupHeader99"
...
func (v OriginalTransactionReference36) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalTransactionReference36"
...
func (v PaymentReturnV12) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentReturnV12"
...
func (v PaymentTransaction146) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction146"
	if v.RtrId != nil {
...
func (v TransactionParties10) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "TransactionParties10"
	if v.UltmtDbtr != nil {
		fedwire.AddError(&errs, baseName+".UltmtDbtr", v.UltmtDbtr.Validate())
	}
	fedwire.AddError(&errs, baseName+".Dbtr", v.Dbtr.Validate())
