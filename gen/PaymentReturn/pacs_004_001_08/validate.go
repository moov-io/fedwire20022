...
// Validations for urn:iso:std:iso:20022:tech:xsd:pacs.004.001.08
...
func (v GroupHeader72) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "GroupHeader72"
...
func (v OriginalGroupHeader12) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalGroupHeader12"
...
func (v PaymentReturnReason4) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentReturnReason4"
	if v.Orgtr != nil {
...
func (v PaymentReturnV08) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentReturnV08"
...
func (v PaymentTransaction87) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction87"
	if v.RtrId != nil {
...
func (v TransactionParties5) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "TransactionParties5"
	if v.UltmtDbtr != nil {
		fedwire.AddError(&errs, baseName+".UltmtDbtr", v.UltmtDbtr.Validate())
	}
	fedwire.AddError(&errs, baseName+".Dbtr", v.Dbtr.Validate())
