...
package EndpointDetailsReport_camt_052_001_08
...
func (v AccountReportingFedwireFunds1) Validate() error {
	if err := fedwire.ValidateEnumeration(string(v), "DTLS", "DTLR"); err != nil {
		return err
	}
	return nil
}
...
func (v BankTransactionCodeFedwireFunds1) Validate() error {
	if err := fedwire.ValidateEnumeration(string(v), "SENT", "RCVD", "DBIT", "CRDT", "ICPT", "RJCT", "INPR"); err != nil {
		return err
	}
	return nil
}
...
func (v ReportTimingFRS1) Validate() error {
	if err := fedwire.ValidateEnumeration(string(v), "IDAY"); err != nil {
		return err
	}
	return nil
}
