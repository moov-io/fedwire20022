...
// Validations for urn:iso:std:iso:20022:tech:xsd:camt.029.001.08
...
func (v AmendmentInformationDetails12) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "AmendmentInformationDetails12"
...
func (v CancellationStatusReason3) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CancellationStatusReason3"
	if v.Orgtr != nil {
...
func (v CaseAssignment4) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CaseAssignment4"
	fedwire.AddError(&errs, baseName+".Id", v.Id.Validate())
...
func (v ClaimNonReceipt1) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "ClaimNonReceipt1"
...
func (v ClaimNonReceipt1Choice) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "ClaimNonReceipt1Choice"
	if v.Accptd != nil {
...
func (v Compensation1) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "Compensation1"
	fedwire.AddError(&errs, baseName+".Amt", v.Amt.Validate())
...
func (v CorrectivePaymentInitiation3) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CorrectivePaymentInitiation3"
	if v.GrpHdr != nil {
		fedwire.AddError(&errs, baseName+".GrpHdr", v.GrpHdr.Validate())
	}
	if v.PmtInfId != nil {
...
func (v CorrectiveTransaction3Choice) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "CorrectiveTransaction3Choice"
	if v.Initn != nil {
...
func (v InvestigationStatus4Choice) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "InvestigationStatus4Choice"
	if v.Conf != nil {
...
func (v MandateRelatedInformation12) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "MandateRelatedInformation12"
	if v.MndtId != nil {
...
func (v ModificationStatusReason1) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "ModificationStatusReason1"
	if v.Orgtr != nil {
		fedwire.AddError(&errs, baseName+".Orgtr", v.Orgtr.Validate())
	}
	if v.Rsn != nil {
...
func (v OriginalGroupHeader9) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalGroupHeader9"
...
func (v OriginalPaymentInstruction26) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalPaymentInstruction26"
...
func (v OriginalTransactionReference27) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalTransactionReference27"
...
func (v PaymentTransaction84) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction84"
	if v.CxlStsId != nil {
...
func (v PaymentTransaction85) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction85"
	if v.CxlStsId != nil {
		fedwire.AddError(&errs, baseName+".CxlStsId", v.CxlStsId.Validate())
	}
	if v.RslvdCase != nil {
...
func (v PaymentTransaction90) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction90"
	if v.ModStsId != nil {
...
func (v ResolutionInformation2) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "ResolutionInformation2"
	if v.IntrBkSttlmAmt != nil {
		fedwire.AddError(&errs, baseName+".IntrBkSttlmAmt", v.IntrBkSttlmAmt.Validate())
	}
	if v.IntrBkSttlmDt != nil {
...
func (v ResolutionOfInvestigationV08) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "ResolutionOfInvestigationV08"
...
func (v StatementResolutionEntry3) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "StatementResolutionEntry3"
	if v.OrgnlGrpInf != nil {
		fedwire.AddError(&errs, baseName+".OrgnlGrpInf", v.OrgnlGrpInf.Validate())
	}
...
func (v UnderlyingTransaction19) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "UnderlyingTransaction19"
