...
func (v Compensation2) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "Compensation2"
	fedwire.AddError(&errs, baseName+".Amt", v.Amt.Validate())
...
func (v OriginalPaymentInstruction30) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalPaymentInstruction30"
...
func (v PaymentTransaction103) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction103"
	if v.CxlStsId != nil {
		fedwire.AddError(&errs, baseName+".CxlStsId", v.CxlStsId.Validate())
	}
	if v.RslvdCase != nil {
...
func (v PaymentTransaction107) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction107"
	if v.ModStsId != nil {
