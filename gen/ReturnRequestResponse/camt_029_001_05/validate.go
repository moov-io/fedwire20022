...
// Validations for urn:iso:std:iso:20022:tech:xsd:camt.029.001.05
...
func (v OriginalPaymentInstruction10) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalPaymentInstruction10"
...
func (v PaymentTransaction53) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction53"
	if v.CxlStsId != nil {
...
func (v PaymentTransaction54) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction54"
	if v.CxlStsId != nil {
		fedwire.AddError(&errs, baseName+".CxlStsId", v.CxlStsId.Validate())
	}
	if v.RslvdCase != nil {
...
func (v ResolutionOfInvestigationV05) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "ResolutionOfInvestigationV05"
...
func (v UnderlyingTransaction9) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "UnderlyingTransaction9"
