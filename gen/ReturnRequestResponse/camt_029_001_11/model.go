...
// Models for urn:iso:std:iso:20022:tech:xsd:camt.029.001.11
...
type AmendmentInformationDetails14 struct {
	...
	OrgnlFnlColltnDt *fedwire.ISODate                              `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 OrgnlFnlColltnDt,omitempty"`
...
type Case5 struct {
	...
	ReopCaseIndctn *YesNoIndicator `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 ReopCaseIndctn,omitempty"`
}
...
type CaseAssignment5 struct {
	...
	CreDtTm fedwire.ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 CreDtTm"`
}
...
type ChargesRecord3 struct {
	...
	ChrgInclInd *ChargeIncludedIndicator                      `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 ChrgInclInd,omitempty"`
	Tp          *ChargeType3Choice                            `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 Tp,omitempty"`
	Rate        *PercentageRate                               `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 Rate,omitempty"`
...
type ClaimNonReceipt2 struct {
	DtPrcd      fedwire.ISODate                               `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 DtPrcd"`
...
type CorrectiveGroupInformation1 struct {
	...
	CreDtTm *fedwire.ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 CreDtTm,omitempty"`
}
...
type CorrectiveInterbankTransaction3 struct {
	...
	IntrBkSttlmDt  fedwire.ISODate                   `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 IntrBkSttlmDt"`
}
...
type CorrectivePaymentInitiation5 struct {
	...
	ReqdColltnDt *fedwire.ISODate                  `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 ReqdColltnDt,omitempty"`
}
...
type CreditTransferMandateData1 struct {
	...
	DtOfSgntr    *fedwire.ISODate           `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 DtOfSgntr,omitempty"`
	DtOfVrfctn   *fedwire.ISODateTime       `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 DtOfVrfctn,omitempty"`
	ElctrncSgntr *Max10KBinary              `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 ElctrncSgntr,omitempty"`
	FrstPmtDt    *fedwire.ISODate           `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 FrstPmtDt,omitempty"`
	FnlPmtDt     *fedwire.ISODate           `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 FnlPmtDt,omitempty"`
...
type DateAndDateTime2Choice struct {
	Dt   *fedwire.ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 Dt,omitempty"`
	DtTm *fedwire.ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 DtTm,omitempty"`
}

type DateAndPlaceOfBirth1 struct {
	BirthDt     fedwire.ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 BirthDt"`
...
type DatePeriod2 struct {
	FrDt fedwire.ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 FrDt"`
	ToDt fedwire.ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 ToDt"`
}
...
type DocumentLineIdentification1 struct {
	...
	RltdDt *fedwire.ISODate   `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 RltdDt,omitempty"`
}
...
type FrequencyPeriod1 struct {
	Tp        Frequency6Code `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 Tp"`
	CntPerPrd DecimalNumber  `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 CntPerPrd"`
}
...
type Garnishment3 struct {
	...
	FmlyMdclInsrncInd *TrueFalseIndicator                `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 FmlyMdclInsrncInd,omitempty"`
	MplyeeTermntnInd  *TrueFalseIndicator                `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 MplyeeTermntnInd,omitempty"`
}
...
type InvestigationStatus5Choice struct {
	...
	RjctdMod       []ModificationStatusReason1Choice                `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 RjctdMod"`
	DplctOf        *Case5                                           `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 DplctOf,omitempty"`
	AssgnmtCxlConf *YesNoIndicator                                  `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 AssgnmtCxlConf,omitempty"`
}
...
type MandateRelatedInformation15 struct {
	MndtId        *Max35Text                     `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 MndtId,omitempty"`
	DtOfSgntr     *fedwire.ISODate               `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 DtOfSgntr,omitempty"`
	AmdmntInd     *TrueFalseIndicator            `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 AmdmntInd,omitempty"`
	...
	FrstColltnDt  *fedwire.ISODate               `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 FrstColltnDt,omitempty"`
	FnlColltnDt   *fedwire.ISODate               `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 FnlColltnDt,omitempty"`
	Frqcy         *Frequency36Choice             `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 Frqcy,omitempty"`
	Rsn           *MandateSetupReason1Choice     `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 Rsn,omitempty"`
...
type NumberOfCancellationsPerStatus1 struct {
	...
	DtldCtrlSum *DecimalNumber                    `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 DtldCtrlSum,omitempty"`
}
...
type OriginalGroupHeader14 struct {
	...
	OrgnlCreDtTm     *fedwire.ISODateTime              `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 OrgnlCreDtTm,omitempty"`
	OrgnlNbOfTxs     *Max15NumericText                 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 OrgnlNbOfTxs,omitempty"`
	OrgnlCtrlSum     *DecimalNumber                    `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 OrgnlCtrlSum,omitempty"`
...
type OriginalTransactionReference35 struct {
	...
	IntrBkSttlmDt  *fedwire.ISODate                              `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 IntrBkSttlmDt,omitempty"`
	ReqdColltnDt   *fedwire.ISODate                              `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 ReqdColltnDt,omitempty"`
	ReqdExctnDt    *DateAndDateTime2Choice                       `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 ReqdExctnDt,omitempty"`
...
type PaymentTransaction132 struct {
	...
	OrgnlIntrBkSttlmDt  *fedwire.ISODate                   `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 OrgnlIntrBkSttlmDt,omitempty"`
...
type PaymentTransaction139 struct {
	...
	OrgnlReqdColltnDt *fedwire.ISODate                   `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 OrgnlReqdColltnDt,omitempty"`
	OrgnlTxRef        *OriginalTransactionReference35    `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 OrgnlTxRef,omitempty"`
}
...
type TaxData1 struct {
	...
	Dt              *fedwire.ISODate                   `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 Dt,omitempty"`
	SeqNb           *Number                            `xml:"urn:iso:std:iso:20022:tech:xsd:camt.029.001.11 SeqNb,omitempty"`
