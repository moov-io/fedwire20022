...
// Validations for urn:iso:std:iso:20022:tech:xsd:camt.029.001.04
...
func (v OriginalPaymentInstruction3) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalPaymentInstruction3"
...
func (v PaymentTransaction39) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction39"
	if v.CxlStsId != nil {
...
func (v PaymentTransaction40) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction40"
	if v.CxlStsId != nil {
		fedwire.AddError(&errs, baseName+".CxlStsId", v.CxlStsId.Validate())
	}
	if v.RslvdCase != nil {
...
func (v ResolutionOfInvestigationV04) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "ResolutionOfInvestigationV04"
...
func (v UnderlyingTransaction4) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "UnderlyingTransaction4"
