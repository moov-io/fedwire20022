...
// Validations for urn:iso:std:iso:20022:tech:xsd:camt.029.001.06
...
func (v OriginalPaymentInstruction17) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "OriginalPaymentInstruction17"
...
func (v PaymentTransaction66) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction66"
	if v.CxlStsId != nil {
...
func (v PaymentTransaction67) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "PaymentTransaction67"
	if v.CxlStsId != nil {
		fedwire.AddError(&errs, baseName+".CxlStsId", v.CxlStsId.Validate())
	}
	if v.RslvdCase != nil {
...
func (v ResolutionOfInvestigationV06) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "ResolutionOfInvestigationV06"
...
func (v UnderlyingTransaction14) Validate() error {
	var errs base.ErrorList = base.ErrorList{}
	baseName := "UnderlyingTransaction14"
