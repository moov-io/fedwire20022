...
type CreditTransferTransaction36 struct {
	...
	UltmtDbtr          *BranchAndFinancialInstitutionIdentification6 `xml:"UltmtDbtr,omitempty"`
	...
	UltmtCdtr          *BranchAndFinancialInstitutionIdentification6 `xml:"UltmtCdtr,omitempty"`
	InstrForCdtrAgt    []*InstructionForCreditorAgent2               `xml:"InstrForCdtrAgt,omitempty"`
	...
	UndrlygCstmrCdtTrf *CreditTransferTransaction37                  `xml:"UndrlygCstmrCdtTrf,omitempty"`
...
type InstructionForCreditorAgent2 struct {
	Cd       *Instruction5Code `xml:"Cd,omitempty"`
	InstrInf *Max140Text       `xml:"InstrInf,omitempty"`
}
