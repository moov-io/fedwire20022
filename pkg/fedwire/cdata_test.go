...
type TestStructNamespace struct {
	AddtlData *fedwire.Cdata `xml:"mr:AddtlData,omitempty"`
}

func TestCdata_write(t *testing.T) {
	input := TestStruct{AddtlData: &fedwire.Cdata{CDataString: cdataText}}
...
func TestCdata_write_withNamespace(t *testing.T) {
	input := TestStructNamespace{AddtlData: &fedwire.Cdata{CDataString: cdataText}}
...
func TestCdata_read(t *testing.T) {
	...
	assert.Equal(t, &TestStruct{AddtlData: &fedwire.Cdata{CDataString: cdataText}}, output)
}
